...
CREATE TABLE `bill`  (
  ...
  CONSTRAINT `bill_ibfk_1` FOREIGN KEY (`ID_USER`) REFERENCES `user` (`ID_USER`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `comment`  (
  ...
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`ID_USER`) REFERENCES `user` (`ID_USER`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('17130000', 'hoanghuy', '123456', 'Hoang Huy', 'hoanghuy@gmail.com', '013245987', 'KH');
INSERT INTO `user` VALUES ('17130115', 'admin1', 'admin', 'ADMIN', 'admin@gmail.com', '0123456789', 'admin');
INSERT INTO `user` VALUES ('17130116', 'admin2', 'admin', 'ADMIN', 'admin@gmail.com', '0123456789', 'admin');
INSERT INTO `user` VALUES ('17130117', 'admin3', 'admin', 'ADMIN', 'admin@gmail.com', '0123456789', 'admin');
