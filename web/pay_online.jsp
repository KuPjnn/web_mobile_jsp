            ...
            <div class="col-md-6 col-12 mx-auto pb-5">
                <div class="card m-auto">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="get" action="<c:url value="/pay_online"/>">
                            ...
                            <input type="hidden" name="data_sign" value="<c:out value="${requestScope.data_sign}"/>">
                            <input type="hidden" name="signatures" value="<c:out value="${requestScope.signatures}"/>">
                            <hr>
                            <div align="center">
                                <button class="btn btn_pay px-5" type="submit">OK</button>
                                <a class="btn btn-secondary px-5" href="<c:url value="/show_cart"/>"> HỦY </a>
                            </div>
                        </form>
                    </div>
                </div>
